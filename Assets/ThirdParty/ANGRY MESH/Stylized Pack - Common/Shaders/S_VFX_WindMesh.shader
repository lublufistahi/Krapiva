	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float3 texCoord65 = input.ase_texcoord2.xyz;
				texCoord65.xy = input.ase_texcoord2.xyz.xy * float2( 1,1 ) + float2( 0,0 );
...
ASEEND*/
//CHKSM=40CE4425672ED7F6893B19C591D55DA794286FDE